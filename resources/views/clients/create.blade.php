            ...
            <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                <div class="mt-2">
                    <label class="inline-flex items-center text-gray-600 dark:text-gray-400">
                        <input type="radio"
                               ...
                               name="type_of_client"
                               @checked(old('type_of_client') == \App\Enums\ClientType::PERSON->value)
                               value="{{ \App\Enums\ClientType::PERSON->value }}"
                               id="radio" onchange="addInput()"
                        />
                    ...
                    <label class="inline-flex items-center ml-6 text-gray-600 dark:text-gray-400">
                        <input type="radio"
                               class="text-purple-600 form-radio focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"
                               name="type_of_client"
                               @checked(old('type_of_client') == \App\Enums\ClientType::COMPANY->value)
                               value="{{ \App\Enums\ClientType::COMPANY->value }}"
                               id="radio" onchange="addInput()"
                        />
                ...
                <label class="block mt-4 text-sm">
                    ...
                    <input
                        ...
                        placeholder="Enter the company name" name="company_name" value="{{ old('company_name') }}"
                    />
                    @error('company_name')
                        <span class="text-xs text-red-600 dark:text-red-400">
                            {{ $message }}
                ...
                <label class="block mt-4 text-sm" id="type_of_client">
                    ...
                    @elseif($errors->any() && old('type_of_client') == \App\Enums\ClientType::COMPANY->value)
                        ...
                        <input id="type_of_client_input"
                               class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                               placeholder="Enter a name" name="registration_number"
                               value="{{ old('registration_number') }}"
                        />
                    @endif
                </label>
                <label class="block mt-4 text-sm">
                    <span class="text-gray-700 dark:text-gray-400">Contact name</span>
                    <input
                        class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                ...
                <label class="block mt-4 text-sm">
                    <span class="text-gray-700 dark:text-gray-400">Contact email</span>
                    <!-- focus-within sets the color for the icon when input is focused -->
                    <div class="relative text-gray-500 focus-within:text-purple-600 dark:focus-within:text-purple-400">
                        <input
                            class="block w-full pl-10 mt-1 text-sm text-black dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray form-input"
